...
class LaunchDetailHeaderView: UIView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            launchNameLabel.topAnchor.constraint(equalTo: topAnchor, constant: 30),
            ...
            launchDateLabel.topAnchor.constraint(equalTo: launchNameLabel.bottomAnchor, constant: 15),
    ...
    func setupView(launchObject: Launch?) {
        
        guard let launchObject = launchObject else {
            return
        }
